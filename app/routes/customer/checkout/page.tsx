      ...
      <>
        {getCartTotal() > 0 && (
          <section id="order-total" className="max-w-2xl sm:max-w-4xl md:max-w-6xl mx-auto">
            <p className="text-2xl bg-secondary text-primary px-3 py-2 rounded-2xl flex items-center shadow-md shadow-secondary">
              ...
              <section className="max-w-2xl sm:max-w-4xl md:max-w-6xl mx-auto flex flex-col m-2 bg-secondary p-2 rounded-2xl text-primary shadow-md shadow-secondary">
                ...
                <div className="mt-2 space-y-2">
                  <button
                    ...
                    className="w-full px-4 py-2 transition duration-700 ease-in-out transform rounded-2xl bg-primary hover:bg-tertiary text-secondary flex items-center justify-center gap-2"
                  >
      ...
      <>
        {prevOrders && prevOrders.length > 0 && (
          <section id="previous-orders" className="max-w-2xl sm:max-w-4xl md:max-w-6xl mx-auto mt-8 text-secondary">
            <h3 className="text-4xl bg-secondary text-primary px-3 py-2 rounded-2xl flex items-center mb-2 shadow-md shadow-secondary">My Orders</h3>
            {prevOrders
              .sort((a: any, b: any) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime())
              .map((order: any, index: number) => (
                <div key={index} className="bg-secondary/80 text-primary p-4 rounded-2xl mb-4">
