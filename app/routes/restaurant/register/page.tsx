...
export default function RegisterPage() {
  ...
  const formFields = [
    { label: "Email Address", icon: FaEnvelope, type: "email", field: "email" as UserDataKey, readOnly: true },
    { label: "Restaurant Pincode", icon: FaMapPin, type: "text", field: "pincode" as UserDataKey },
    { label: "Restaurant Address", icon: FaMapMarkerAlt, type: "text", field: "address" as UserDataKey },
    { label: "Restaurant Phone Number", icon: FaPhone, type: "tel", field: "phoneNumber" as UserDataKey },
    { label: "Restaurant Opening Hour", icon: FaClock, type: "time", field: "openingHour" as UserDataKey },
    { label: "Restaurant Closing Hour", icon: FaClock, type: "time", field: "closingHour" as UserDataKey },
    { label: "Owner Aadhaar Number", icon: FaIdCard, type: "text", field: "aadhaarNumber" as UserDataKey },
    { label: "Owner PAN Card Number", icon: FaIdCard, type: "text", field: "panCardNumber" as UserDataKey },
