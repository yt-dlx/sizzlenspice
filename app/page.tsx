    ...
    <React.Fragment>
      <main className="max-w-full mx-auto overflow-hidden bg-gradient-to-b from-[#1c3029]/30 from-10% via-[#171717] via-40% to-[#111111] to-50% p-4">
        ...
        <section className="flex flex-col items-center justify-center max-w-2xl sm:max-w-4xl md:max-w-6xl lg:max-w-7xl mx-auto py-4">
          <p className="text-2xl lg:text-5xl md:text-center font-Grenoble gap-2 py-4 text-[#E9F0CD]">
          ...
          <div className="gap-2 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
            {categories.map((category, index) => (
              <a
                key={index}
                className="flex flex-col rounded-lg shadow border-2 border-[#1C2924] overflow-hidden h-full"
              >
                <Image
                  src={category.image}
                  width={200}
