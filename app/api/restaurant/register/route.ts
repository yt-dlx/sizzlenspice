...
export async function POST(request: NextRequest) {
  ...
  const { email, name, phoneNumber, address, pincode, openingHour, closingHour, aadhaarNumber, panCardNumber, panCardFirstName, panCardLastName } = result.data;
  try {
    ...
    const restaurant = await prisma.restaurant.create({
      data: { email, name, address, pincode, phoneNumber, openingHour, closingHour, aadhaarNumber, panCardNumber, panCardFirstName, panCardLastName },
    });
