...
export default function Error({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="bg-primary p-4">
      <header id="header" className="max-w-2xl sm:max-w-4xl md:max-w-6xl mx-auto flex flex-col md:justify-center md:items-center sm:text-center text-secondary">
        ...
        <Image src="/svg/error.gif" alt="Error illustration" width={300} height={300} className="mx-auto object-cover h-80 sm:h-96 lg:h-112 hue-rotate-180" />
      </header>
      <main className="flex items-center justify-center">
        <div className="max-w-2xl sm:max-w-4xl md:max-w-6xl mx-auto flex flex-col p-8 m-2 bg-secondary/10 rounded-lg text-secondary">
          ...
          <div className="mt-6 space-y-2">
            <Link href="/routes" className="w-full p-2 transition duration-700 ease-in-out transform rounded-full bg-secondary hover:bg-[#A8B67C] text-primary flex items-center justify-center gap-2">
