            ...
            <div className="mx-auto overflow-hidden bg-[#FFF4E9] max-w-6xl p-2">
                <div className="m-2">
                    ...
                    <form
                        ...
                        className="flex flex-col max-w-7xl bg-[#172B25] p-8 rounded-2xl text-[#E6DFD4] shadow-md shadow-[#172B25] pb-10"
                    >
                        ...
                        <div className="space-y-2 mt-2">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 transition duration-700 ease-in-out transform rounded-full bg-[#468353]/60 hover:bg-[#468353] placeholder-[#FFF4E9] hover:placeholder-[#FFF4E9] flex items-center justify-center text-center gap-2 border-2 border-[#172B25]"
                            />
                            <input required type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="password" className="w-full px-4 py-2 transition duration-700 ease-in-out transform rounded-full bg-[#468353]/60 hover:bg-[#468353] placeholder-[#FFF4E9] hover:placeholder-[#FFF4E9] flex items-center justify-center text-center gap-2 border-2 border-[#172B25]" />
                            <button type="submit" className="w-full px-4 py-2 transition duration-700 ease-in-out transform rounded-full bg-[#FFF4E9] hover:bg-[#468353] text-[#172B25] hover:text-[#FFF4E9] flex items-center justify-center text-center gap-2">
