              ...
              <div className="px-2">
                <div className="flex justify-between items-center">
                  <div className="flex items-center space-x-2">
                    <div
                      className={`w-4 h-4 rounded-full ${selectedItem.genre === "veg" ? "bg-lime-400" : "bg-red-600"}`}
                    />
                ...
                <p className="text-sm mb-8 text-center font-RobotoCondensed">
            ...
            >
              ...
              <div className="text-[#E9F0CD] flex flex-col justify-between rounded-b m-0.5 py-2 bg-[#2B4B40]/40 flex-grow p-2">
                <div className="flex justify-between items-center">
                  <div className="flex items-center space-x-2">
                    <div
                      className={`w-4 h-4 rounded-full ${item.genre === "veg" ? "bg-lime-400" : "bg-red-600"}`}
                    />
      ...
      {cart.length > 0 && !isCartOpen && (
        <section id="cart-button" className="fixed bottom-14 right-2">
          <button
            ...
            className="bg-[#E9F0CD] text-[#172B25] p-2 rounded-lg shadow shadow-[#131313] flex items-center"
          >
            ...
            <div className="p-4 w-full overflow-y-auto">
              <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={() => setIsCartOpen(false)}>
                  <MdClose
                    size={24}
                    className="text-[#1C3029] bg-[#E9F0CD] rounded-full font-bold animate-spin"
                  />
                </button>
              </div>
