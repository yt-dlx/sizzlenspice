// app/home/restaurant/orders/page.tsx
"use client";
  ...
  return (
    <main className="max-w-full mx-auto overflow-hidden bg-gradient-to-b from-[#1C3029]/30 from-10% via-[#171717] via-40% to-[#131313] to-50% p-4 text-[#E9F0CD]">
      <section id="header" className="max-w-2xl sm:max-w-4xl md:max-w-6xl mx-auto flex flex-col md:justify-center md:items-center sm:text-center text-[#E9F0CD] font-Playfair mb-8">
        <h1 className="text-8xl sm:text-9xl font-bold text-[#E9F0CD]">Order Management</h1>
      ...
      <div className="max-w-2xl sm:max-w-4xl md:max-w-6xl mx-auto">
        ...
        <section id="DashboardSummary">
          <header className="text-4xl font-bold mb-1 font-Kurale bg-[#E9F0CD] text-[#172B25] shadow shadow-[#131313] px-3 py-2 rounded-lg flex items-center justify-center">My Work Summary</header>
          <ul className="grid grid-cols-2 md:grid-cols-4 gap-2">
            <li className="bg-[#E9F0CD]/10 p-1 rounded-lg shadow shadow-[#131313] border-2 border-[#131313] text-[#E9F0CD] flex flex-col items-center justify-center text-center">
          ...
          <div className="lg:col-span-1">
            <div className="bg-[#E9F0CD]/10 rounded-lg shadow-md p-4 text-[#E9F0CD]">
              ...
              <div className="space-y-4">
                {orders.map((order) => (
                  <div key={order._id} className={`p-4 rounded-lg cursor-pointer ${selectedOrder?._id === order._id ? "bg-[#1C2924]" : "bg-[#E9F0CD]/10"}`} onClick={() => setSelectedOrder(order)}>
            ...
            {selectedOrder ? (
              <div className="bg-[#E9F0CD]/10 rounded-lg shadow-md p-4 text-[#E9F0CD]">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button onClick={() => toggleVisualize(selectedOrder._id)} className="bg-[#E9F0CD] text-[#172B25] px-3 py-1 rounded-full flex items-center font-bold text-xs font-Kurale">
                    ...
                    {statusOptions.map((status) => (
                      <button
                        ...
                        className={`px-4 py-2 mb-2 transition duration-700 ease-in-out transform rounded-full ${
                          selectedOrder.status === status ? "bg-[#A8B67C] text-[#172B25]" : "bg-[#E9F0CD] hover:bg-[#A8B67C] text-[#172B25]"
